...
class Calc:
    ...
    def initial_format(self):
        if self.N == 4:
            self.string_main1 = "№ " + "{:^10} " * self.amount_of_x + "{:^12}" *(
                    len(self.main_caption) - self.amount_of_x)
            self.string_main2 = "{} " + "| {:^6} | " * self.amount_of_x + "|{:^9}| " *(
                    len(self.main_caption) - self.amount_of_x)
        elif self.N == 8:
            self.string_main1 = "№ " + "{:^10} " * 3 + "{:^12} "*3 + "{:^13}" + "{:^12}" *(
                    len(self.main_caption) - self.amount_of_x)
            self.string_main2 = "{} " + "| {:^6} | " * 3 + "| {:^8} | " * 3 + "| {:^8} | " + "|{:^9}| " *(
                    len(self.main_caption) - self.amount_of_x)
        else:
        ...
        self.string_y_average2 = "|{:^7}| " * self.N
        if self.N == 4:
